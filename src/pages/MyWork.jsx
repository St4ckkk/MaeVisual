...
const MyWork = () => {
    ...
    return (
        ...
        >
            <Navbar />
            <motion.div
                className="max-w-7xl mx-auto px-2 sm:px-4 py-6 sm:py-10 relative z-10"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{
                    duration: 0.8,
            ...
            >{/* Category Tabs */}
                <motion.div
                    className="flex flex-wrap justify-center mb-8 border-b border-gray-700 relative pb-1 px-2"
                ...
                <Card
                    ...
                    initialImageIndex={selectedImage || 0}
                />
            </motion.div>
            <Footer />
        </div>
